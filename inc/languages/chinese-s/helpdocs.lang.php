...
// Help Document 5
$l['d5_name'] = "发布新主题";
$l['d5_desc'] = "在一个版块中发布一个新主题。";
$l['d5_document'] = "当你去到你有兴趣的版块并想发布新的主题，只需按版块上方或下方的 \"新主题\"按钮。请注意你可能没有在每个版块都有发布新主题的权限，因为管理员可能将发帖限制到管理人员，或者完全将版块存档。";

// Help Document 6
$l['d6_name'] = "发表回复";
$l['d6_desc'] = "回复一个版块的主题。";
$l['d6_document'] = "在你浏览论坛时，你可能会遇到你想回复的主题。要回复，按主题下方或上方的 \"新回复\" 按钮。注意，你的管理员可能限制特定个人在一些版块发布回复。
